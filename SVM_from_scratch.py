...
class SVM:
    ...
    def fit(self, X, y,  gif_filename='SVM.gif'):
        ...
        for _ in range(self.n_iters):
            ...
            # Visualize figure while optimizing weights and bias, combine all figure to GIF
            fig = plt.figure()
            ...
            # Create a canvas that can be rendered to an array
